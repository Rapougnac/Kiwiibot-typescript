//@ts-ignore
import * as AmeClient from 'amethyste-api';
import { Message, MessageEmbed, MessageAttachment, GuildMember } from 'discord.js';
...
export default class ThreeTousandYearsCommand extends Command {
  ...
  async execute(client: Client, message: Message, args: string[]) {
    ...
    if(message.guild){
      ...
      if (args.length <= 0) member = message.member as GuildMember | undefined;
