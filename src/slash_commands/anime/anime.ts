      ...
      collector?.on('collect', async (i) => {
        ...
        if (i.customId === 'anime') {
          ...
          embed
            ...
            .addField(
              `❯\u2000 ${interaction.guild?.i18n.__mf('anime.stats')}`,
              `•\u2000 **${interaction.guild?.i18n.__mf('anime.note')}** ${
                anime.score
              }\n•\u2000 **${interaction.guild?.i18n.__mf('anime.rank')}** ${
                anime.ranked
              }\n•\u2000 **${interaction.guild?.i18n.__mf(
                'anime.poularity'
              )}** ${anime.popularity}`,
            ...
            .addField(
              ...
              `•\u2000 **Episodes:** ${
                ...
                endDate?.trim() === '?'
                  ? interaction.guild.i18n.__mf('anime.in_progress')
